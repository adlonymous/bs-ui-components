...
const ShopItemOpen = (props: Props) => {
  return (
    <div className="flex flex-col justify-between font-dm gap-6 bg-white px-8 py-4 rounded-lg shadow-sm  max-w-[848px] w-full border-gray-300 z-[1100]">
      <div id="image-carousel" className="flex flex-col gap-4 justify-start">
        <div id="main-image">
          <img
            src="/singaporef1.png"
            alt="singapore-img"
            className="w-[361px] h-[361px] object-cover scale-x-110 rounded-md"
          />
        </div>
        <div id="other-images" className="flex flex-row gap-3 justify-around">
          <img
            src="/singaporef1.png"
            alt="singapore-img"
